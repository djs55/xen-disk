...
(* OASIS_START *)
(* DO NOT EDIT (digest: c928b2a325d75d8bdd9e33c17f5ecf9d) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("mirage-block-xen", None);
                           FindlibPackage ("mirage-block-xen.back", None);
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "z'\208>\147\198A\195\187\230\174\182\143\204\249t";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;

...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1c5306157011b9c548f6337d3fee352d) *)
(*
...
let setup_t =
  {
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("vhd", None);
                           FindlibPackage ("xenblock", None);
                           FindlibPackage ("xenblock.back", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "d\171\168\235\031\007X2\150\244\211z:+\000\220";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;

...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1b660418a0ebe977e4cbf09d48cf5243) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Xen virtual disk backend which understands .vhd format";
          description = None;
          categories = [];
     ...
     oasis_version = "0.3.1";
     oasis_digest =
       Some "\210\178\152\166\005\234\021\230\185\r\178\205m\027\240-";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;

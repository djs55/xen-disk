...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2323eb6df16d309428f5b86640b12055) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Bindings for cross-domain memory mapping and event notification under Xen";
          description = None;
          categories = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources = ["gnttab_stubs.c"; "evtchn_stubs.c"];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["Activations"; "Gnttab"; "Evtchn"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "grant-table";
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("xenstore_client_unix", None);
                           InternalLibrary "grant_table";
                           FindlibPackage ("lwt", None);
                           FindlibPackage ("lwt.unix", None);
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\198?\195h\"\164\207\236\241\011|\128.\127\216>";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;

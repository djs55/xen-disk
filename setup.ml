...
(* OASIS_START *)
(* DO NOT EDIT (digest: b80c111a22c1144a2a5faf256643f3ee) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Activations"; "Gnttab"];
                      lib_pack = false;
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "?d\006\221\031\003-\193\014\139h\254\204~O\031";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
